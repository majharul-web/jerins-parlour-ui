...
const Order = ({ id }) => {
    ...
    return (
        <div style={{ margin: '5rem 0' }}>
            <h3 style={{ textAlign: 'center', fontSize: '2rem' }}> Confirm Your <span style={{ color: '#F63E7B' }}>Order</span></h3>
                ...
                <Grid container spacing={2} sx={{ mt: 2, display: 'flex', justifyContent: 'center', alignItems: 'center' }} >
                    ...
                    <Grid item md={6} sm={12} xs={12}>
                        ...
                        <div style={{ margin: '0 auto' }}>
                            ...
                            <h3 style={{ textAlign: 'center', fontSize: '30px' }}> <span style={{ color: '#F63E7B' }}>Order Details</span></h3>

                            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                <Box sx={{ border: '1px solid gray', borderRadius: '5px', padding: '20px 30px', width: '70%' }}>
